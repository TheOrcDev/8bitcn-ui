...
const browserCollections = {
  docs: create.doc("docs", {
    ...
    "components/chart.mdx": () =>
      import("../content/docs/components/chart.mdx?collection=docs"),
    ...
    "components/combo-box.mdx": () =>
      import("../content/docs/components/combo-box.mdx?collection=docs"),
    ...
    "components/enemy-health-display.mdx": () =>
      import(
        "../content/docs/components/enemy-health-display.mdx?collection=docs"
      ),
    "components/health-bar.mdx": () =>
      import("../content/docs/components/health-bar.mdx?collection=docs"),
    ...
    "components/mana-bar.mdx": () =>
      import("../content/docs/components/mana-bar.mdx?collection=docs"),
    ...
    "components/retro-mode-switcher.mdx": () =>
      import(
        "../content/docs/components/retro-mode-switcher.mdx?collection=docs"
      ),
    ...
    "components/sidebar.mdx": () =>
      import("../content/docs/components/sidebar.mdx?collection=docs"),
    ...
    "components/theme-selector.mdx": () =>
      import("../content/docs/components/theme-selector.mdx?collection=docs"),
    ...
    "blocks/authentication/index.mdx": () =>
      import("../content/docs/blocks/authentication/index.mdx?collection=docs"),
    "blocks/authentication/login-form-2.mdx": () =>
      import(
        "../content/docs/blocks/authentication/login-form-2.mdx?collection=docs"
      ),
    "blocks/authentication/login-form-with-image.mdx": () =>
      import(
        "../content/docs/blocks/authentication/login-form-with-image.mdx?collection=docs"
      ),
    "blocks/authentication/login-form.mdx": () =>
      import(
        "../content/docs/blocks/authentication/login-form.mdx?collection=docs"
      ),
    "blocks/authentication/login-page.mdx": () =>
      import(
        "../content/docs/blocks/authentication/login-page.mdx?collection=docs"
      ),
    "blocks/charts/chart-area-step.mdx": () =>
      import(
        "../content/docs/blocks/charts/chart-area-step.mdx?collection=docs"
      ),
    "blocks/charts/chart-bar-multiple.mdx": () =>
      import(
        "../content/docs/blocks/charts/chart-bar-multiple.mdx?collection=docs"
      ),
    "blocks/charts/chart-bar.mdx": () =>
      import("../content/docs/blocks/charts/chart-bar.mdx?collection=docs"),
    "blocks/charts/index.mdx": () =>
      import("../content/docs/blocks/charts/index.mdx?collection=docs"),
    "blocks/calendar/calendar-block.mdx": () =>
      import(
        "../content/docs/blocks/calendar/calendar-block.mdx?collection=docs"
      ),
    "blocks/calendar/calendar-range.mdx": () =>
      import(
        "../content/docs/blocks/calendar/calendar-range.mdx?collection=docs"
      ),
    "blocks/calendar/calendar-single.mdx": () =>
      import(
        "../content/docs/blocks/calendar/calendar-single.mdx?collection=docs"
      ),
    "blocks/calendar/index.mdx": () =>
      import("../content/docs/blocks/calendar/index.mdx?collection=docs"),
    "blocks/dashboard/dashboard-01.mdx": () =>
      import(
        "../content/docs/blocks/dashboard/dashboard-01.mdx?collection=docs"
      ),
    "blocks/dashboard/index.mdx": () =>
      import("../content/docs/blocks/dashboard/index.mdx?collection=docs"),
    "blocks/gaming/audio-settings.mdx": () =>
      import(
        "../content/docs/blocks/gaming/audio-settings.mdx?collection=docs"
      ),
    "blocks/gaming/chapter-intro.mdx": () =>
      import("../content/docs/blocks/gaming/chapter-intro.mdx?collection=docs"),
    "blocks/gaming/dialogue.mdx": () =>
      import("../content/docs/blocks/gaming/dialogue.mdx?collection=docs"),
    "blocks/gaming/difficulty-select.mdx": () =>
      import(
        "../content/docs/blocks/gaming/difficulty-select.mdx?collection=docs"
      ),
    "blocks/gaming/game-over.mdx": () =>
      import("../content/docs/blocks/gaming/game-over.mdx?collection=docs"),
    "blocks/gaming/index.mdx": () =>
      import("../content/docs/blocks/gaming/index.mdx?collection=docs"),
    "blocks/gaming/leaderboard.mdx": () =>
      import("../content/docs/blocks/gaming/leaderboard.mdx?collection=docs"),
    "blocks/gaming/main-menu.mdx": () =>
      import("../content/docs/blocks/gaming/main-menu.mdx?collection=docs"),
    "blocks/gaming/pause-menu.mdx": () =>
      import("../content/docs/blocks/gaming/pause-menu.mdx?collection=docs"),
    "blocks/gaming/player-profile-card.mdx": () =>
      import(
        "../content/docs/blocks/gaming/player-profile-card.mdx?collection=docs"
      ),
    "blocks/gaming/quest-log.mdx": () =>
      import("../content/docs/blocks/gaming/quest-log.mdx?collection=docs"),
  }),
};
